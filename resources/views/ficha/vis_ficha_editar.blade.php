...
<div>
	<section id="entradas" name="entradas" >
		...
		<input id="txtdiametroe1" name="txtdiametroe1" class='columna' type="text" required value="<?php echo "{$datos->diametro_e1}"; ?>" placeholder="diametro 1"/>
		...
		<input id="txtdiametroe2" name="txtdiametroe2" class='columna' type="text" required value="<?php echo "{$datos->diametro_e2}"; ?>" placeholder="diametro 2"/>
		...
		<input id="txtdiametroe3" name="txtdiametroe3" class='columna' type="text" required value="<?php echo "{$datos->diametro_e3}"; ?>" placeholder="diametro 3"/>
		...
		<input id="txtdiametroe4" name="txtdiametroe4" class='columna' type="text" required value="<?php echo "{$datos->diametro_e4}"; ?>" placeholder="diametro 4"/>
		...
		<input id="txtdiametroe5" name="txtdiametroe5" class='columna' type="text" required value="<?php echo "{$datos->diametro_e5}"; ?>" placeholder="diametro 5"/>
		...
		<input id="txtdiametroe6" name="txtdiametroe6" class='columna' type="text" required value="<?php echo "{$datos->diametro_e6}"; ?>" placeholder="diametro 6"/>
		...
		<input id="txtdiametroe7" name="txtdiametroe7" class='columna' type="text" required value="<?php echo "{$datos->diametro_e7}"; ?>" placeholder="diametro 7"/>
		...
		<input id="txtdiametroe8" name="txtdiametroe8" class='columna' type="text" required value="<?php echo "{$datos->diametro_e8}"; ?>" placeholder="diametro 8"/>
		...
		<input id="txtdiametroe9" name="txtdiametroe9" class='columna' type="text" required value="<?php echo "{$datos->diametro_e9}"; ?>" placeholder="diametro 9"/>
		...
		<input id="txtdiametroe10" name="txtdiametroe10" class='columna' type="text" required value="<?php echo "{$datos->diametro_e10}"; ?>" placeholder="diametro 10"/>
		...
		<input id="txtdiametroe11" name="txtdiametroe10" class='columna' type="text" required value="<?php echo "{$datos->diametro_e11}"; ?>" placeholder="diametro 11"/>
		...
		<input id="txtdiametroe12" name="txtdiametroe12" class='columna' type="text" required value="<?php echo "{$datos->diametro_e12}"; ?>" placeholder="diametro 12"/>
		{!! $errors->first('txtdiametroe12', '<p class="error_mensaje">:message</p>') !!}
		
		<input id="txtalturae12" name="txtalturae10" class='columna' type="text" required value="<?php echo "{$datos->altura_e12}"; ?>" placeholder="altura 12"/>
		{!! $errors->first('txtalturae10', '<p class="error_mensaje">:message</p>') !!}
